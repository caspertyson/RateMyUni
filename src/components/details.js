...
const DetailComponent = ({ onRowClick, triggerEvent }) => {
  ...
  const aboutMassey = (<div>
      ...
      <a href='https://www.massey.ac.nz/' target='_blank'> Learn more about Massey University.</a></div>);

  const aboutCanterbury = (<div>
      Canterbury University, nestled in Christchurch, New Zealand, stands as a prestigious institution known for academic excellence. Embracing the city's vibrant culture and natural beauty, studying at Canterbury University becomes an extraordinary experience. Challenges like adapting to the weather and occasional seismic activity foster resilience. Students find inspiration in tranquil spots like Hagley Park and the Botanic Gardens. The university cultivates innovation and collaboration, empowering students to make meaningful contributions. Beyond academics, Christchurch offers a thriving arts scene and vibrant nightlife. It's important to approach the local environment with respect, cherishing the city's history. Embrace the fusion of academic rigor and Christchurch's spirit at Canterbury University, embarking on a transformative journey.
      <a href='https://www.canterbury.ac.nz/' target='_blank'> Learn more about Canterbury University.</a></div>);
  
  const aboutWellington = (<div>
      ...
      <a href='https://www.wgtn.ac.nz/' target='_blank'> Learn more about Victoria University of Wellington.</a></div>);
  
  const aboutLincoln = (<div>
      ...
      <a href='https://www.lincoln.ac.nz/' target='_blank'> Learn more about Lincoln University.</a></div>);
  ...
  const aboutAUT = (<div>
      ...
      <a href='https://www.aut.ac.nz/' target='_blank'> Learn more about Auckland University of Technology (AUT).</a></div>);

  const aboutWaikato = (<div>
      ...
      <a href='https://www.waikato.ac.nz/' target='_blank'> Learn more about the University of Waikato.</a></div>);
